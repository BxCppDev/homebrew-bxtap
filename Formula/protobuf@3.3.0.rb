class ProtobufAT330 < Formula
  ...
  def install
    ...
    if build.with? "java"
      ...
      system "cp" , "#{buildpath}/java/core/target/protobuf-java-3.3.0.jar",      "#{prefix}/lib/java/"
      system "cp" , "#{buildpath}/java/util/target/protobuf-java-util-3.3.0.jar", "#{prefix}/lib/java/"
    end
